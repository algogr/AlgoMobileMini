...
import kotlinx.android.synthetic.main.activity_cash_open.*
import kotlinx.android.synthetic.main.content_cash_open.*
import kotlinx.android.synthetic.main.content_cash_open.acceptButton3
import kotlinx.android.synthetic.main.content_cash_open.cancelButton3
import kotlinx.android.synthetic.main.content_collection_avtivity.*
import kotlinx.android.synthetic.main.content_expenses.*

class CashOpenActivity : AppCompatActivity() {

    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        setContentView(R.layout.activity_cash_open)
        setSupportActionBar(toolbar)
        setTitle("Άνοιγμα Ταμείου")


        acceptButton3.setOnClickListener{
            val amount = amountEdit3.text.toString().toFloatOrNull()
